...
// Test Cases
const testCases = [
  { arr: [4, 2, 7, 1, 9, 5], target: 8, expected: true }, // Typical case with positive numbers
  { arr: [1, 2, 3, 4, 5], target: 6, expected: true }, // Case with multiple possible subarrays
  { arr: [1, 4, 3, 7, 5], target: 20, expected: true }, // Case where the entire array sums to the target
  { arr: [1, 2, 9, 4, 3], target: 21, expected: false }, // Case where no subarray sums to the target
  { arr: [0, 0, 0, 0], target: 0, expected: true }, // Case with zeroes
  { arr: [2], target: 4, expected: false }, // Single element array that does not match the target
